...
const Results = () => {
	...
	const [hoveredDimension, setHoveredDimension] =
		useState<keyof InvestorReport["dimensions"]>("timeHorizon");
		...
		<div className="min-h-screen py-12 px-4">
			<div className="max-w-7xl mx-auto space-y-8">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					<Card
						className="p-8 space-y-6 shadow-card animate-slide-up"
					...
					>
						...
						<div className="space-y-8">
							...
							<PersonalityBar
								...
								label2="Windfall"
								percentage={percentages.windfall}
								color="#f25e62"
								delay={1000}
